...
def extract_pixel_values():
    ip_dir = "/home/dell/Downloads/DSAPS/Q3/data/input/"
    ip_img = sys.argv[1]
    ip_file = "rgb_in.txt"
    # Read input image
...
def compile_and_run_cpp():
    ...
    os.system("/home/dell/Downloads/DSAPS/Q3/src/main.cpp -o /home/dell/Downloads/DSAPS/Q3/src/main")
    print("[*] Compilation Successful, Executing ./bin/main \n")
    # run the binary file
    os.system("/home/dell/Downloads/DSAPS/Q3/src/main")

# ---------------------------------------------------------------------

def create_output_image():
    op_file = "rgb_out.txt"
    op_dir = "/home/dell/Downloads/DSAPS/Q3/data/output/"
